...
// 8. split() - break the string into multiple parts based on the delimiter,
// returns an array
...
// welcometo typescript and javascript

//11.  concept of string immutability
...
// 12. Multiline string is allowed with backtick operator
